...
SRA_FILE, SAMPLES, and GUIDE_METADATA CSVs.
...
`{prefix}_SRA_BIOSAMPLE.csv`, `{prefix}_SRA_FILE.csv`, `{prefix}_SAMPLES.csv`,
and `{prefix}_GUIDE_METADATA.csv`. SAMPLES and GUIDE_METADATA are omitted when
