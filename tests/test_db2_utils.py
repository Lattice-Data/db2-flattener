...
def test_combine_bound_columns_equal_and_unequal():
    ...
    result = combine_bound_columns(df, lower_col="lower", upper_col="upper", out_col="combined")
...
def test_sort_ontology_term_id_column_reorders_paired_labels():
    ...
    result = sort_ontology_term_id_column(df, "experimental_condition_ontology_term_id")
...
def test_sort_ontology_term_id_column_set_becomes_joined_string():
    ...
    result = sort_ontology_term_id_column(df, "self_reported_ethnicity_ontology_term_id")
...
def test_sort_ontology_term_id_column_no_paired_column():
    df = pd.DataFrame({"experimental_condition_ontology_term_id": [["EFO:2", "EFO:1"]]})
    result = sort_ontology_term_id_column(df, "experimental_condition_ontology_term_id")
    assert result["experimental_condition_ontology_term_id"].iloc[0] == "EFO:1 || EFO:2"
